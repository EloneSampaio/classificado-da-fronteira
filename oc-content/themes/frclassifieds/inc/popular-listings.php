<div class="container-fluid">
  <div class="well clearfix">
     <h3 class="section-title">
         <?php
               $words = explode(' ', 'Popular Listings');
               for($x = 0; $x <= 0; $x++) { 
  ...
  <div  class="well"> 
       <div class="related-items-wrapper">
         ...
         <div id="carousel-search_related" class="owl-carousel owl-theme">
            <?php popular_listings(); ?>
            <?php if( osc_has_custom_items() == 0) { ?>
                <p class="empty"><?php _e('No Popular Ads', 'frclassifieds') ; ?></p>
              <?php } else { ?>
                      ...
                      <div class="listed-item">
                         <?php if( osc_images_enabled_at_items() ) { ?>
                          ...
                          if(osc_item_is_premium()){
                                echo '<div class="tringle-up-right"></div><div class="tringle-up-right-back"></div><i id="item-'. osc_item_id().'-popular" class="fa fa-star premium-icon" title="Premium!" ></i>
                                <script type="text/javascript">
                                   //PREMIUM ITEM STAR ICON TOOLTIP
                                      $(document).ready(function() {
                                          $("#item-'. osc_item_id().'-popular").uitooltip({
                                              track:true
                                          });
                                      });
                            </script>';
