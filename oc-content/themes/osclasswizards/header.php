...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-8589533899832551",
        ...
        <div class="main-search">
          <div class="form-filters">
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="cell selector">
                  <?php osclasswizards_regions_select('sRegion', 'sRegion', __('Seleciona a região', OSCLASSWIZARDS_THEME_FOLDER)) ; ?>
                </div>
              </div>
              <div class="col-md-2">
                <div class="cell selector">
                  <?php osclasswizards_cities_select('sCity', 'sCity', __('Seleciona a cidade', OSCLASSWIZARDS_THEME_FOLDER)) ; ?>
                </div>
              </div>
