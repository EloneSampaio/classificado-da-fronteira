<?php
     ...
     */
     ...
     $sQuery = osc_get_preference('keyword_placeholder', 'brasil');
?>
...
<form action="<?php echo osc_base_url(true); ?>" method="get" class="search" onsubmit="javascript:return doSearch();">
    ...
    <fieldset class="main">
        ...
        <?php  if ( osc_count_categories() ) { ?>
            <?php osc_categories_select('sCategory', null, __('Select a category', 'brasil')); ?>
        <?php  } ?>
    	<button type="submit"><?php _e('Search', 'brasil'); ?></button>
    </fieldset>
