...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content home">
            <div id="main" class="home-left-side">
               ...
               <div class="latest_ads">
                    <h1><strong><?php _e('Latest Listings', 'brasil'); ?></strong></h1>
                    ...
                    <?php } else { ?>
                        ...
                        <p class='pagination'><?php echo osc_search_pagination(); ?></p>
                            <p class="see_more_link"><a href="<?php echo osc_search_show_all_url();?>"><strong><?php _e("See all offers", 'brasil'); ?> &raquo;</strong></a></p>
                        <?php } ?>
        ...
        <div class="clear"></div>
        <?php if( osc_get_preference('homepage-728x90', 'brasil') != '') { ?>
        <!-- homepage ad 728x60-->
        <div class="ads_728">
            <?php echo osc_get_preference('homepage-728x90', 'brasil'); ?>
        </div>
        <!-- /homepage ad 728x60-->
        <?php } ?>
        <!-- map js -->
