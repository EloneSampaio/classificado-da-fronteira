...
function brasil_is_fineuploader() {
...
function theme_brasil_regions_map_admin() {
    ...
    switch (Params::getParam('action_specific')) {
        case('edit_region_map'):
            ...
            osc_set_preference('region_maps', json_encode($regions), 'brasil');
            osc_add_flash_ok_message(__('Region saved correctly', 'brasil'), 'admin');
            header('Location: ' . osc_admin_render_theme_url('oc-content/themes/brasil/admin/map_settings.php'));
            exit;
            break;
    }
}
