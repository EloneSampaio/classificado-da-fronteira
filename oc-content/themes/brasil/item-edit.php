...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content add_item">
            <h1><strong><?php _e('Update your listing', 'brasil'); ?></strong></h1>
            <ul id="error_list"></ul>
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="secret" value="<?php echo osc_item_secret();?>" />
                        <div class="box general_info">
                            ...
                            <div class="row">
                                <label><?php _e('Category', 'brasil'); ?> *</label>
                            ...
                            <div class="row price">
                                <label><?php _e('Price', 'brasil'); ?></label>
                        ...
                        <?php }?>
                    <button class="itemFormButton" type="submit"><?php _e('Update', 'brasil'); ?></button>
                    <a href="javascript:history.back(-1)" class="go_back"><?php _e('Cancel', 'brasil'); ?></a>
                </fieldset>
            </form>
        </div>
