            ...
            <div id="main">
                <div class="ad_list">
                    ...
                    <?php if(osc_count_items() == 0) { ?>
                        <p class="empty" ><?php printf(__('There are no results matching "%s"', 'brasil'), osc_search_pattern()); ?></p>
                    <?php } else { ?>
                ...
                <div class="filters">
                    <form action="<?php echo osc_base_url(true); ?>" method="get" onsubmit="return doSearch()" class="nocsrf">
                        ...
                        <fieldset class="box location">
                            <h3><strong><?php _e('Your search', 'brasil'); ?></strong></h3>
                            <div class="row one_input">
                                <input type="text" name="sPattern" id="query" value="<?php echo osc_esc_html( osc_search_pattern() ); ?>" />
                                <div id="search-example"></div>
                            </div>
                            <h3><strong><?php _e('Location', 'brasil'); ?></strong></h3>
                            <div class="row one_input">
                                <h6><?php _e('City', 'brasil'); ?></h6>
                        ...
                        <fieldset class="box show_only">
                            ...
                            <h3><strong><?php _e('Show only', 'brasil'); ?></strong></h3>
                            <div class="row checkboxes">
                                <ul>
                                    <li>
                                        <input type="checkbox" name="bPic" id="withPicture" value="1" <?php echo (osc_search_has_pic() ? 'checked="checked"' : ''); ?> />
                                        <label for="withPicture"><?php _e('Show only listings with pictures', 'brasil'); ?></label>
                                    </li>
                                </ul>
                            </div>
                            <?php } ?>
                        ...
                        ?>
                        <button type="submit"><?php _e('Apply', 'brasil'); ?></button>
                    </form>
                    <?php osc_alert_form(); ?>
                </div>
            </div>
                ...
                $(function() {
                    ...
                    $( "#sCity" ).autocomplete({
                        ...
                        select: function( event, ui ) {
                            ...
                            log( ui.item ?
                                "<?php _e('Selected', 'brasil'); ?>: " + ui.item.value + " aka " + ui.item.id :
                                "<?php _e('Nothing selected, input was', 'brasil'); ?> " + this.value );
                        }
                    });
                });
