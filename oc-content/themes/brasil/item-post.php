...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    <head>
        ...
        <!-- only item-post.php -->
        <?php
        if (brasil_default_location_show_as() == 'dropdown') {
        ...
        ?>
        <?php
        if(osc_images_enabled_at_items() && !brasil_is_fineuploader()) {
    ...
    <body>
        ...
        <div class="content add_item">
            <h1><strong><?php _e('Publish a listing', 'brasil'); ?></strong></h1>
            <ul id="error_list"></ul>
            <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="page" value="item" />
                    <div class="box general_info">
                        <h2><?php _e('General Information', 'brasil'); ?></h2>
                        <div class="row">
                            <label for="catId"><?php _e('Category', 'brasil'); ?> *</label>
                            <?php ItemForm::category_multiple_selects(null, null, __('Select a category', 'brasil')); ?>
                        </div>
                        <div class="row">
                    ...
                    <div class="box price">
                        <label for="price"><?php _e('Price', 'brasil'); ?></label>
                    ...
                    <div class="box photos">
                        <?php
                            if(osc_images_enabled_at_items()) {
                                if(brasil_is_fineuploader()) {
                                    // new ajax photo upload
                                    ItemForm::ajax_photos();
                                }
                            } else { ?>
                        <h2><?php _e('Photos', 'brasil'); ?></h2>
                        <div id="photos">
                            <div class="row">
                                <input type="file" name="photos[]" />
                            </div>
                        </div>
                        <a href="#" onclick="addNewPhoto(); uniform_input_file(); return false;"><?php _e('Add new photo', 'brasil'); ?></a>
                    ...
                    <div class="box location">
                        <h2><?php _e('Listing Location', 'brasil'); ?></h2>
                        <?php if(count(osc_get_countries()) > 1) { ?>
                        <div class="row">
                            <label for="countryId"><?php _e('Country', 'brasil'); ?></label>
                            <?php ItemForm::country_select(osc_get_countries(), osc_user()); ?>
                        </div>
                        <div class="row">
                            <label for="regionId"><?php _e('Region', 'brasil'); ?></label>
                            <?php
                            if (brasil_default_location_show_as() == 'dropdown') {
                        ...
                        <div class="row">
                            <label for="city"><?php _e('City Area', 'brasil'); ?></label>
                    ...
                    <div class="box seller_info">
                        <h2><?php _e("Seller's information", 'brasil'); ?></h2>
                        <div class="row">
                            <label for="contactName"><?php _e('Name', 'brasil'); ?></label>
                            <?php ItemForm::contact_name_text(); ?>
                        </div>
                        <div class="row">
                            <label for="contactEmail"><?php _e('E-mail', 'brasil'); ?> *</label>
                        ...
                        <div class="row">
                            ...
                            <label for="showEmail" style="width: 250px;"><?php _e('Show e-mail on the listing page', 'brasil'); ?></label>
                        </div>
                    </div>
                    <?php }; ?>
                    ...
                    <?php }?>
                <div class="clear"></div>
                <button  type="submit"><?php _e('Publish', 'brasil'); ?></button>
                </fieldset>
            </form>
        </div>
